...
*/
function clearAll() {
  // gets a list of all of the elements with the class 'outpu'
  const elementsToRemove = document.querySelectorAll('.output');
...
*/
function showMeme() {
  // clears the content in the page before generating output
  clearAll();

  // Value is a string representing image URL
  const randomMemeUrl = getRandomData('memes');

  // creates an image tag with the class 'output'
  const memeImage = document.createElement('img');
  memeImage.src = randomMemeUrl;
  memeImage.className = 'output';

  // creates a break-line tag with the class 'output'
  const br = document.createElement('br');
  br.className = 'output';

  // finds the header tag below which memes will be displayed
  const memeHeader = document.querySelector('#memes');

  // displays the meme below the meme header
  memeHeader.appendChild(br);
  memeHeader.appendChild(memeImage);
}
...
function showJoke() {
  ...
  // creates a paragraph tag with the class 'output' and with the generated joke
  const jokeParagraph = document.createElement('p');
  jokeParagraph.className = 'output';
  ...
  // displays the joke below the joke header
  const jokeHeader = document.querySelector('#jokes');
  jokeHeader.appendChild(br);
  jokeHeader.appendChild(jokeParagraph);
}
...
function showQuote() {
  ...
  // creates a paragraph element with the class 'output' and with the generated quote
  const quoteParagraph = document.createElement('p');
  quoteParagraph.className = 'output';
  quoteParagraph.textContent = randomQuote.quote;

  // creates a paragraph elemenmt with the class 'output' and with the quote's author
  const authorParagraph = document.createElement('p');
  authorParagraph.className = 'output';
  ...
  // displays the quote and the author below the quote heaeder
  const quoteHeader = document.querySelector('#quotes');
  quoteHeader.appendChild(br);
  quoteHeader.appendChild(quoteParagraph);
  quoteHeader.appendChild(authorParagraph);
}
...
function showRiddle() {
  ...
  // displays the riddle but not the answer
  const riddleHeader = document.querySelector('#riddles');
  riddleHeader.appendChild(br);
  riddleHeader.appendChild(riddleParagraph);
  riddleHeader.appendChild(riddleAnswer);
}
...
function revealAnswers() {
  // finds the riddle answer paragraph tag
